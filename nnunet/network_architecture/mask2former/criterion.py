...
from nnunet.network_architecture.mask2former.utils import is_dist_avail_and_initialized, nested_tensor_from_tensor_list
...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_masks):
        ...
        if self.cfg.loss.cls_type == 'focal':
            loss_focal = multi_cls_focal_loss(src_logits.transpose(1, 2), target_classes)
