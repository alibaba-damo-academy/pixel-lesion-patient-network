...
#TODO Note: According to PLAN paper, first train with this config for 500 epochs, then train with cfg_dce_plan2 for 500
...
model = dict(
    ...
    # ),
    # consist_loss=dict(train_start_ep=200, type='det_cls', weight=0.1),
)
optimizer = dict(
    max_num_epochs=500,
