...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    if 'use_simplified_train_folder' in cfg and cfg.use_simplified_train_folder:  # YK
        output_folder_name = join(network_training_output_dir)  # don't know why we need such a complex folder structure
    else:
